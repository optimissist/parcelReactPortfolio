...
export default function Experience() {
    ...
    <div className="experience">
        <p className="companyName" onClick={() => setTorrid(!torrid)}><GoChevronDown className={`downChevron ${torrid && 'upChevron'}`} /><a href="https://torrid.com/" target="_blank" rel="noreferrer" id="torrid">
        Torrid</a> — 2023 to Present</p>
        {torrid ? <span> <p className="contentProducer">Digital Content Producer • April 2023 to Present</p>
            <Producer /> </span> : "" }

        <p className="companyName" onClick={() => setBeachbody(!beachbody)}><GoChevronDown className={`downChevron ${beachbody && 'upChevron'}`} /><a href="https://www.teambeachbody.com/" target="_blank" rel="noreferrer" id="tbb">Beachbody</a> — 2018 to 2023</p>
            {beachbody ? <span>
